...
public class PublicTests {
    ...
    public void testMultipleExamsStudents() {
        ...
        manager.answerMultipleChoiceQuestion(laura, examId, 4, new String[]{"A"});
        ...
        manager.answerMultipleChoiceQuestion(mike, examId, 4, new String[]{"A"});
        ...
        manager.answerMultipleChoiceQuestion(john, examId, 4, new String[]{"A", "B", "C"});
    ...
    public void testSerialization() {
        ...
        // System.out.println(restoredManager.getKey(10));
